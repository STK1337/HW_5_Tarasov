...
class Worker
{
    ...
    double premy; // вводим переменные для каждого типа двнных
public:
    void setWorker(string sn, int exp, int sh, int h)
    {
        ...
        premy = p;// ставим условия получения преммии
    }
    void getWorker()
    {
        ...
        file.close(); // это для создания txt документа
    }
};
...
int main()
{
    ...
    cout << "Enter how much hours " << surname << " has worked: "; cin >> hours; cout << endl; // водимим данные о работнике и получаем ответ
    Worker objWorker;
